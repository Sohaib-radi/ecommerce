...
export const _productNames = [
  'جل استحمام كريمي برائحةالمسك',
  'ﺷﺎﻣﺒﻮ اﻟﻤﺴﻚ اﻷﺳﻮد',
  'شامبو للمحجبات بالمسك الاسود',
  'صابونةالمسك الاسود',
  'مناديل مبللةلإزالةالعرق',
  'بوكس هدية من مسك ',
...
export const _descriptions = [
  `جل الاستحمام الكريمي برائحة المسك هو تجربة حمام فاخرة تمزج بين نعومة الجل ورقة الكريم، مع رائحة المسك الساحرة. يمنحك هذا الجل تنظيفًا فعّالًا وفاخرًا لبشرتك، في حين يترك رائحة المسك الرائعة تحفز حواسك وتمنحك لحظات استرخاء لا مثيل لها. استمتع بتجربة الاستحمام الفاخرة مع هذا الجل الكريمي الذي يضفي لمسة من الفخامة إلى روتينك اليومي`,
  `تم تصميم شامبو المسك الأسود الأصلي للعناية بالشعر لتزويدك بتجربة ممتعة فريدة من نوعها للعناية بالشعر. يتكون هذا المزيج الفعال من المسك الأسود الأصلي وزيت الأرغان ، ويعمل بشكل متناغم لتغذية وتجديد شباب شعرك. تضفي إضافة المسك الأسود الخام لمسة من الفخامة ورائحة ساحرة ، بينما يرطب زيت الأرجان خيوط شعرك بعمق ، ويتركها كالحرير والنعومة وسهلة التصفيف. بمكوناته الطبيعية وتركيزه على تعزيز صحة فروة الرأس ونمو الشعر ، يقدم شامبو المسك الأسود الأصلي خياراً فاخراً ومثالياً لمن يبحثون عن روتين جديد ومبتكر للعناية بالشعر.`,
  ...
  `صابونة المسك الأسود تعتبر رفيقًا فاخرًا في روتين العناية بالبشرة. تمتاز بتركيبتها الغنية والفاخرة التي تجمع بين فوائد فعّالة لتنظيف البشرة وتغذيتها. تحتوي الصابونة على رائحة المسك الأسود الفريدة، مما يمنح تجربة استحمام غنية بالحس الفاخر والجاذبية.
  تقدم صابونة المسك الأسود ترطيبًا فائقًا للبشرة، مساعدة في تحسين ملمسها وإعادة تجديد حيويتها. يترك هذا الصابون بشرتك بمظهر نضر ومشرق، ويضفي لمسة من الفخامة على روتين العناية بالجسم اليومي. اكتشفي جمال العناية بالبشرة مع صابونة المسك الأسود، لتحصلي على بشرة ناعمة ومشرقة تشع بالجمال.`,
  
  `مناديل مبللة لإزالة العرق هي إضافة رائعة إلى روتين العناية الشخصية اليومي. تمنحك هذه المناديل الفعّالة راحة فورية ونظافة مثالية أثناء استخدامها. بفضل تركيبتها المبتكرة، تقدم هذه المناديل التي تحتوي على مواد مهدئة ومنظفة تجربة منعشة ومنعشة.
  تمتاز المناديل بخفة الوزن وسهولة الاستخدام، مما يجعلها مثالية للاستخدام في أي وقت وفي أي مكان. تساعد في إزالة العرق والشوائب من الجلد، مما يتركك بإحساس بالانتعاش والنظافة. احملي هذه المناديل المبللة في حقيبتك لتحافظي على إحساسك بالانتعاش أثناء تنقلاتك اليومية، مما يجعلها جزءًا أساسيًا من روتينك اليومي للعناية بالجسم`,
  `صندوق الهدايا من مسك هو هدية فاخرة تمنحك تجربة استثنائية. يحتوي هذا البوكس على مجموعة منتقاة من منتجات مسكية تضفي لمسة من الفخامة والجمال. ستجد في داخل الصندوق`,
